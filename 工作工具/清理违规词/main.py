...
if __name__=="__main__":
    ...
    #要处理的文件列表
    old_path=r"C:\Users\ZG\Desktop\EVERWK"
    ...
    #new_path=r"C:\Users\ZG\Desktop\EVERWK_New"
    if os.path.exists(new_path):
        pass
    else:
        os.mkdir(new_path) 
    #侵权词列表
    #infringing_path=r'C:\Users\ZG\Desktop\changetitle\侵权词删除\infringing_word_list.txt'
    ...
    for key in result:
        ...
        for region in result[key]:
            ...
            for l in result[key][region]['Listings']:
                ...
                print('%s\t%s\t%s\t%s\t%s'%(key,region,l['path'],l['file'],new_path_file))
                #保存成功结果 successfull
                successfull_file=os.path.join(new_path,"successfull.csv")
                wt_csv(successfull_file,[l['file']])
            # 保存
        # print()
